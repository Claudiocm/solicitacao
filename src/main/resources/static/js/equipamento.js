// processa o auto-complete de servicos
$(function() {
	...
	// adiciona a tag de input com o serviço no html 
	function addServico(titulo) {
		$('#listaServicos')
			.append('<input type="hidden" value="'+ titulo +'" name="servicos">');
	}
	
	// mostra na pagina um toast com mensagem de servicos repetidos 
		...
		.autocomplete({
			...
			select : function(event, ui) {
				...
				if (exists === false) {				
					...
					exibeMessagem('O serviço <b>'+ ui.item.value +'</b> já foi selecionado.');
				}
				return false;
			}
		});
